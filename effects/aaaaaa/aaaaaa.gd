...
# Visual Descriptions
const ID : int = Effects.AAAAAA
const effect_name : String = "AAAAAA" 
const effect_type : Hud.effect_type = Hud.effect_type.MOVE
const description : String = "The affected character's [img=16]res://assets/icons/stats/res_neutral.webp[/img]Resistance is reduced by [color=c90032]15[/color] for only one question."
